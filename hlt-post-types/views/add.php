...
if(isset($_POST['add_save'])){
    ...
    if(!empty($field_name) && !empty($type) && !empty($status) ){
        $wpdb->insert( $hlt_pt_fields_table, 
        	array( 
                'hlt_pt_id' => $p_type_id, 
        		'name' => $field_name, 
        		'type' => $type, 
        ...
        echo hlt_pt_display_msg('Field record has been added successfully',1);
    }
    else{
        //error
...
<div class="wrap">
<h2><?php echo $hlt_pt->name; ?>&nbsp; &gt;&gt; &nbsp;Add Field <a href="<?php echo admin_url('admin.php?page=hlt-pt-post-types&hlt_pg=field-settings&id='.$p_type_id);?>" class="add-new-h2">Back</a></h2>
